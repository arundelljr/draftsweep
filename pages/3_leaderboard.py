...
st.write(f"Last updated at {time.values[0][0]}")
...
if control_panel['Update Leaderboard'][0] == 1:
    ...
    if st.button("Update Leaderboards"):
        ...
        conn.update(data=time_df, worksheet="friends_last_update")
...
if control_panel['Display Leaderboards'][0] == 0 and control_panel['Update Leaderboard'][0] == 0:
